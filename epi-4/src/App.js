//* As we are making food delivery app so for that here is the structure
/**
 * Header
 * -Logo
 * -Nav items
...
//* In real world we make config driven UI where data coming from backend displays in a way that it can be use as others

//* A "config-driven UI" is a user interface that is built and configured using a declarative configuration file or data structure, rather than being hardcoded.
...
function Header() {
  return (
    <div className="header">
      <div className="logo">
        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTU1x4_Y8m00ZlmL8BedNTcC-FgjQKENQYSDA&s" />
      </div>
